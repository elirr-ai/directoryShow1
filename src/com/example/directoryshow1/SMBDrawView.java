...
public class SMBDrawView extends View {
...
//    Bitmap bitmap;
    ...
    public SMBDrawView(Context context) {
        super(context);
        init();
    }
    ...
    public SMBDrawView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public SMBDrawView(Context context, AttributeSet attrs, int defStyle) {
